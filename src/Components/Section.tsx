    ...
    return(
        <div className="w-screen flex flex-col bg-lightGrayishBlue text-center pt-10   " >
            ...
            <div className="w-screen flex flex-col md:grid md:grid-cols-2 pt-10 lg:flex lg:flex-row lg:justify-center lg:h-[30rem]">
                <span>
                    <img src="src\assets\images\icon-online.svg" alt="err" className="w-24 m-auto py-5"/>
                ...
                <span>
                    <img src="src\assets\images\icon-budgeting.svg" alt="err" className="w-24 m-auto py-5" />   
                ...
                <span>
                    <img src="src\assets\images\icon-onboarding.svg" alt="err" className="w-24 m-auto py-5" />
                ...
                <span>
                    <img src="src\assets\images\icon-api.svg" alt="err" className="w-24 m-auto py-5" />
