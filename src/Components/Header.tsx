    ...
    return (
        <div className="w-screen  flex flex-col  md:flex-row-reverse  md:pb-16 lg:pb-48  lg:  " >
            <div className="relative bg-hero-pattern-mb bg-no-repeat bg-cover bg-right  md:bg-none basis-4/6 md:min-w-[50%]"  >
                <img src={mockups} alt="hero-logo" className="z-10 h-[23rem] overflow-visible m-auto  md:h-[30rem] px-5 md:absolute md:right-0  md:p-0 md:overflow-hidden lg:right-20 lg:h-[40rem]" />
                <img src={bgDesktop} alt="hero-logo" className="hidden	 md:block md:absolute  md:right-[-5rem] md:top-0 md:h-[30rem] lg:h-[56rem] lg:right-[-8rem] lg:-z-10" />
            </div>
