    ...
    return(
        <div className="bg-white mt-16 text-center md:mb-10">
            ...
            <div className="text-center m-auto lg:flex lg:flex-row">
                <div>
                    <img src={currency} alt="err" className="px-5 m-auto lg:h-72"/>
                ...
                <div>
                    <img src={restaurant} alt="err" className="px-5  m-auto lg:h-72" />
                ...
                <div>
                    <img src={plane} alt="err"  className="px-5 m-auto lg:h-72"/>
                    <h4 className="text-grayishBlue text-xs text-left py-5 px-8">By Wilson Hutton</h4>
                ...
                <div>
                    <img src={conffeti} alt="err"  className="px-5 m-auto lg:h-72"/>
